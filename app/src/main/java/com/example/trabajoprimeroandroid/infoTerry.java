...
public class infoTerry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_info_terry);

        barra = (ProgressBar) findViewById(R.id.barra3);
