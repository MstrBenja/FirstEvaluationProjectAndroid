...
public class infoJin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_info_jin);

        barra = (ProgressBar) findViewById(R.id.barra1);
